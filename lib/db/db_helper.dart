...
class DbHelper {
  ...
  static Future<void> addNewProduct(ProductModel productModel,
    ...
    wb.update(categoryDoc, {
      categoryFieldProductCount: (productModel.category.productCount +
          purchaseModel.purchaseQuantity)
    });
    return wb.commit();
  }
  ...
  static Future<void> repurchase(PurchaseModel purchaseModel,
    ...
    final snapshot = await _db.collection(collectionCategory).doc(
        productModel.category.categoryId).get();
  ...
  static Stream<DocumentSnapshot<Map<String, dynamic>>> getOrderConstants() =>
      _db.collection(collectionOrderConstant)
  ...
  static getAllOrdersByUser(String uid) {}
